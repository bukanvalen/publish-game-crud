    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="card-header text-right">
                <a onclick="confirmAdd(this)" data-url="{{ route('publishers.create') }}" class="btn btn-primary text-white"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a onclick="confirmEdit(this)"
                                            data-url="{{ route('publishers.edit', ['id' => $publisher->id]) }}"
                                            class="btn btn-warning btn-sm text-white" role="button">Edit</a>
                                        <a onclick="confirmDelete(this)"
                                            data-url="{{ route('publishers.delete', ['id' => $publisher->id]) }}"
