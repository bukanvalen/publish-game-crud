    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="card-header text-right">
                <a onclick="confirmAdd(this)" data-url="{{ route('games.create') }}" class="btn btn-primary text-white"
